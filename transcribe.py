...
class BatchedInferencePipeline:
    ...
    def transcribe(
        ...
        info = TranscriptionInfo(
            ...
            average_logprob= self.model.average_logprob,
        )
...
class WhisperModel:
    ...
    def transcribe(
        ...
        info = TranscriptionInfo(
            ...
            vad_options=vad_parameters,
            all_language_probs=all_language_probs,
            average_logprob = self.average_logprob
        )
    ...
    def generate_segments(
        ...
        while clip_idx < len(seek_clips):
            ...
            self.average_logprob = avg_logprob
            #print(f"average Probability of sentence: {avg_logprob}")
